...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_tsangan_hhkb(
    ...
    MO(_ALT_FUNCS), KC_LALT, KC_LGUI,                            KC_SPC,                                          KC_RALT, DF(_GAMER),  KC_RCTL
  ),
  ...
  [_GAMER] = LAYOUT_60_ansi(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,                 KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                                          KC_RALT, KC_RGUI, DF(_BASE), KC_RCTL
  ),

  [_ALT_FUNCS] = LAYOUT_60_ansi(
